        ...
        <div class="container">
            <ul class="top-nav">
                <li class="dropdown top-nav__guest">
                    ...
                    <form action="" method="POST" class="dropdown-menu stop-propagate">
    ...
    <div class="header__recommended">
        ...
        <div class="listings-grid">
            <div class="listings-grid__item">
                <a href="listing-detail.html">
                    <div class="listings-grid__main">
                        <img src="{{asset('img/listing/thumbs/1.jpg')}}" alt="">
            ...
            <div class="listings-grid__item">
                <a href="listing-detail.html">
                    <div class="listings-grid__main">
                        <img src="{{asset('img/listing/thumbs/2.jpg')}}" alt="">
            ...
            <div class="listings-grid__item">
                <a href="listing-detail.html">
                    <div class="listings-grid__main">
                        <img src="{{asset('img/listing/thumbs/3.jpg')}}" alt="">
            ...
            <div class="listings-grid__item">
                <a href="listing-detail.html">
                    <div class="listings-grid__main">
                        <img src="{{asset('img/listing/thumbs/4.jpg')}}" alt="">
            ...
            <div class="listings-grid__item">
                <a href="listing-detail.html">
                    <div class="listings-grid__main">
                        <img src="{{asset('img/listing/thumbs/5.jpg')}}" alt="">
            ...
            <div class="listings-grid__item">
                <a href="listing-detail.html">
                    <div class="listings-grid__main">
                        <img src="{{asset('img/listing/thumbs/6.jpg')}}" alt="">
            ...
            <div class="listings-grid__item">
                <a href="listing-detail.html">
                    <div class="listings-grid__main">
                        <img src="{{asset('img/listing/thumbs/7.jpg')}}" alt="">
            ...
            <div class="listings-grid__item">
                <a href="listing-detail.html">
                    <div class="listings-grid__main">
                        <img src="{{asset('img/listing/thumbs/8.jpg')}}" alt="">
                        <div class="listings-grid__price">$1,175,000</div>
                    </div>
